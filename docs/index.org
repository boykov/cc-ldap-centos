...
#+INCLUDE: /home/eab/git/cc/cc-ldap-centos/gen/client5.diff src diff :lines "1-44" :exports (when (eq org-export-current-backend 'odt) "none")
#+caption: Опции, выставляемые в файлах для *5/2.3* (б)
#+INCLUDE: /home/eab/git/cc/cc-ldap-centos/gen/client5.diff src diff :lines "44-74" :exports (when (eq org-export-current-backend 'odt) "none")
#+caption: Опции, выставляемые в файлах для *5/2.3* (в)
#+INCLUDE: /home/eab/git/cc/cc-ldap-centos/gen/client5.diff src diff :lines "74-" :exports (when (eq org-export-current-backend 'odt) "none")
#+HTML: </div>
...
#+INCLUDE: /home/eab/git/cc/cc-ldap-centos/gen/client6.diff src diff :lines "1-38" :exports (when (eq org-export-current-backend 'odt) "none")
#+caption: Опции, выставляемые в файлах для *6/2.4* (б)
#+INCLUDE: /home/eab/git/cc/cc-ldap-centos/gen/client6.diff src diff :lines "38-73" :exports (when (eq org-export-current-backend 'odt) "none")
#+caption: Опции, выставляемые в файлах для *6/2.4* (в)
#+INCLUDE: /home/eab/git/cc/cc-ldap-centos/gen/client6.diff src diff :lines "73-117" :exports (when (eq org-export-current-backend 'odt) "none")
#+caption: Опции, выставляемые в файлах для *6/2.4* (г)
#+INCLUDE: /home/eab/git/cc/cc-ldap-centos/gen/client6.diff src diff :lines "117-" :exports (when (eq org-export-current-backend 'odt) "none")
#+HTML: </div>
