...
Базовые репозитории дистрибутивов CentOS 5 и CentOS6 содержат 2.3 и 2.4 версию OpenLDAP, соответственно. Выполнив стандартную установку
...
** Настройка базы данных Oracle Berkeley DB
:PROPERTIES:
...
#+HTML: </div>
#+begin_html
<br/><a href="javascript:toggleDiv('myContent-admin');" class="fa">admin.ldif</a>
#+end_html
#+HTML: <div id="myContent-admin" style="display:none">
