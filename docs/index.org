...
|---------------------------+--------------+----------------+-------------------------------|
| *Служба каталогов*        | server-ldif5 | *CentOS 5*     | *OpenLDAP 2.3* server, *ldif* |
| *Служба каталогов*        | server-ldif6 | *CentOS 6*     | *OpenLDAP 2.4* server, *ldif* |
| *Служба каталогов*        | server-conf5 | *CentOS 5*     | *OpenLDAP 2.3* server, *conf* |
| *Служба каталогов*        | server-conf6 | *CentOS 6*     | *OpenLDAP 2.4* server, *conf* |
...
#+begin_src sh :exports results :results org
cat ../ldap-client/Dockerfile5 | grep "openldap\|sendmail" | sed "s|RUN ||g"
#+end_src
...
#+begin_src sh :exports results :results org
cat ../ldap-client/Dockerfile6 | grep "openldap\|sendmail" | sed "s|RUN ||g"
#+end_src
...
| *sudoers.ldif* | создание организационной единицы *sudoers*, добавление настроек по умолчанию для *sudo* и группы *wheel*, включенной в группу администраторов *sudo* |
...
#+caption: *sudoers.ldif*: создание организационной единицы *sudoers*, добавление настроек по умолчанию для *sudo* и группы *wheel*, включенной в группу администраторов *sudo*
#+name: sudo-ldif
