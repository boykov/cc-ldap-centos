...
#+HTML: <div id="myContent" style="display:true">
...
#+begin_html
<a href="javascript:toggleDiv('myContent-manager');" class="fa">manager.ldif</a>
#+end_html
...
Файл src_raw[:exports code]{domain.ldif}:
#+INCLUDE: /home/eab/git/cc/cc-ldap-centos/ldap-server/domain.ldif src ldif

Файл src_raw[:exports code]{base.ldif}:
