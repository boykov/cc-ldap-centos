...
предварительно сформированным каталогом *slapd.d*. Для обеих
конфигураций будем создавать каталог *slapd.d* с нуля при помощи
утилиты *slapadd*, используя *ldif* формат (то есть
