...
#+begin_html
<br/><a onclick="toggleDiv2('myContent-manager',$(this));" class="fa fa-caret-right">/root/manager.ldif</a>
#+end_html
...
#+begin_html
<a onclick="toggleDiv2('myContent-client-files',$(this));" class="fa fa-caret-down">client-files.diff</a>
#+end_html
...
#+begin_html
<a onclick="toggleDiv2('myContent-client',$(this));" class="fa fa-caret-right">client.diff</a>
#+end_html
