...
менеджера схемы *cn=Manager,dc=mercury,dc=febras,dc=net*, добавим 2
подразделения *groups* и *people*. Также, добавим в *domain.ldif*
правила доступа к атрибутам *userPassword* и *shadowLastChange* для
менеджера, владельца и неавторизованного пользователя.
