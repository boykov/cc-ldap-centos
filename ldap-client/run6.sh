#!/bin/bash
# [[file:~/git/cc/cc-ldap-centos/docs/index.org::#authentification][client6-run-prefix]]

cp -R /etc /gen/etc6/etc

# client6-run-prefix ends here
# [[file:~/git/cc/cc-ldap-centos/docs/index.org::#authentification][client6-run-setup]]
...
# [[file:~/git/cc/cc-ldap-centos/docs/index.org::#authentification][client6-run-postfix]]
